...
import { Plus, NotebookPen, Calendar, Video, Trash2, Eye, Edit3, CheckCircle2, Clock, FileText } from "lucide-react";
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-heading font-bold">Meeting Minutes</h1>
            <p className="text-sm text-muted-foreground">Record and generate formal company secretary minutes</p>
          </div>
        </div>
        <Link href="/meeting-minutes/new">
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will permanently delete the meeting and all associated attendees, agenda items, and action items. This cannot be undone.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>Cancel</AlertDialogCancel>
                          <AlertDialogAction onClick={() => handleDelete(meeting.id)} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                            Delete
                          </AlertDialogAction>
                        </AlertDialogFooter>
                      </AlertDialogContent>
